...
class NoPCVisionNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('robot_command_file', '/home/workspace/ros2_ws/src/sem_map_vision/config/robot_command.json')
        self.declare_parameter('map_file_path', '/home/workspace/ros2_ws/src/sem_map_vision/config/map.json')
